...
part of 'persistent_category_repository.dart';
...
class Category extends DataClass implements Insertable<Category> {
  ...
  Category copyWith({int? id, String? name, String? emoji, bool? isIncome}) =>
      Category(
        id: id ?? this.id,
        name: name ?? this.name,
...
class $$CategoriesTableFilterComposer
    extends Composer<_$CategoryDatabase, $CategoriesTable> {
...
class $$CategoriesTableTableManager
    extends
        RootTableManager<
          ...
          (
            Category,
            BaseReferences<_$CategoryDatabase, $CategoriesTable, Category>,
          ),
          Category,
          PrefetchHooks Function()
        > {
  $$CategoriesTableTableManager(_$CategoryDatabase db, $CategoriesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
