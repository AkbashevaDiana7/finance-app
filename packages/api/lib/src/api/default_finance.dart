...
class DefaultFinance {
  final Dio _dio;

  final Serializers _serializers;

  const DefaultFinance(this._dio, this._serializers);
  ...
  Future<Response<BuiltList<Account>>> accountsGet({
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AccountResponse>> accountsIdGet({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/accounts/{id}'.replaceAll('{' r'id' '}',
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AccountHistoryResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AccountHistoryResponse>> accountsIdHistoryGet({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/accounts/{id}/history'.replaceAll('{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
    ...
    AccountHistoryResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(AccountHistoryResponse),
    ...
    return Response<AccountHistoryResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Account>> accountsIdPut({
    required int id,
    required AccountUpdateRequest accountUpdateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AccountUpdateRequest);
      _bodyData =
          _serializers.serialize(accountUpdateRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future] containing a [Response] with a [Account] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Account>> accountsPost({
    required AccountCreateRequest accountCreateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AccountCreateRequest);
      _bodyData =
          _serializers.serialize(accountCreateRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Category>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Category>>> categoriesTypeIsIncomeGet({
    ...
    final _path = r'/categories/type/{isIncome}'.replaceAll(
        '{' r'isIncome' '}',
        encodeQueryParameter(_serializers, isIncome, const FullType(bool))
            .toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
  ...
  /// Parameters:
  /// * [accountId] - ID счета
  /// * [startDate] - Начальная дата периода (YYYY-MM-DD). Если не указана, используется начало текущего месяца.
  /// * [endDate] - Конечная дата периода (YYYY-MM-DD). Если не указана, используется конец текущего месяца.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<TransactionResponse>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<TransactionResponse>>>
    ...
    final _path = r'/transactions/account/{accountId}/period'.replaceAll(
        '{' r'accountId' '}',
        encodeQueryParameter(_serializers, accountId, const FullType(int))
            .toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
    ...
    BuiltList<TransactionResponse>? _responseData;
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> transactionsIdDelete({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/transactions/{id}'.replaceAll('{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TransactionResponse>> transactionsIdGet({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [TransactionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TransactionResponse>> transactionsIdPut({
    required int id,
    ...
    try {
      const _type = FullType(TransactionRequest);
      _bodyData =
          _serializers.serialize(transactionRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Transaction>> transactionsPost({
    required TransactionRequest transactionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
